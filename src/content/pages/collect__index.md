...
<div class="grid">
  <div class="cell cell--bordered cell--12">
    ...
    <div class="hero hero--center hero--dark">
      ...
      <p class="embed-facade" data-embed-facade data-embed-provider="youtube"><a href="https://youtu.be/AhYAywwaVHM" target="_blank" rel="noopener">watch this video on youtube</a></p>
    </div>
...
<hr>
    ...
    <div class="hero hero--center hero--dark hero-buy--linear-gradient">
      <div class="hero__content">
        <p>25 physical cards available. <br> Purchase in our bandcamp store.</p>    
      </div>
    </div>
  

 
      <div class="cell cell--12  cell--lg-4 content"><div>
...
<div class="form-container">
  ...
  <form
   action="https://formspree.io/f/xjvneyen"
    method="POST"
    class="contact-form"
  >
    <label>
