...
# Taller de creación orbital: Orbiters <span class="mark mark--cut mark--tilt-2 mark--tear-3">Orchestra</span> (ES)
...
<section class="carousel" aria-roledescription="carousel" aria-label="5 fotografías"><ul class="carousel__track" role="list" tabindex="0"><li class="carousel__slide" id="carousel-lab-es-ip-orchestra-2-1"><div class="carousel__frame"><img src="/img/collect-landing/2024_ss-12.jpeg" alt="Sesión 12"/></div></li><li class="carousel__slide" id="carousel-lab-es-ip-orchestra-2-2"><div class="carousel__frame"><img src="/img/collect-landing/2024_ss-10.jpeg" alt="Sesión 10"/></div></li><li class="carousel__slide" id="carousel-lab-es-ip-orchestra-2-3"><div class="carousel__frame"><img src="/img/collect-landing/2024_ss-8.jpeg" alt="Sesión 8"/></div></li><li class="carousel__slide" id="carousel-lab-es-ip-orchestra-2-4"><div class="carousel__frame"><img src="/img/collect-landing/2024_ss-11.jpeg" alt="Sesión 11"/></div></li><li class="carousel__slide" id="carousel-lab-es-ip-orchestra-2-5"><div class="carousel__frame"><img src="/img/collect-landing/2024_ss-2.jpeg" alt="Sesión 2"/></div></li></ul></section>
...
<label>Tu correo electrónico:<input type="email" name="email" required></label>
<label>Tu mensaje:<textarea name="message" required></textarea></label>
